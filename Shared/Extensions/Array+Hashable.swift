...
extension Array where Element: Hashable {
    ...
    ///
    /// If an element already appears in the array, only the first element will be returned. This method preserves the order of the array. In this example, wrapping
    /// an `Array` in a `Set` is a simple and quick way to filter duplicate elements, but does not preserve the order of the array.
    ///
    /// ```
