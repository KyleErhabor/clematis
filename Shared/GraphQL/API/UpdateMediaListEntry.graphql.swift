...
public final class UpdateMediaListEntryMutation: GraphQLMutation {
  /// The raw GraphQL definition of this operation.
  public let operationDefinition: String =
    """
    mutation UpdateMediaListEntry($id: Int!, $status: MediaListStatus, $score: Float, $progress: Int, $progressVolumes: Int, $repeat: Int, $priority: Int, $private: Boolean, $notes: String, $hiddenFromStatusLists: Boolean, $customLists: [String], $advancedScores: [Float], $startedAt: FuzzyDateInput, $completedAt: FuzzyDateInput) {
      SaveMediaListEntry(
        id: $id
        status: $status
        score: $score
  ...
  public let operationName: String = "UpdateMediaListEntry"
  ...
  public var variables: GraphQLMap? {
    return ["id": id, "status": status, "score": score, "progress": progress, "progressVolumes": progressVolumes, "repeat": `repeat`, "priority": priority, "private": `private`, "notes": notes, "hiddenFromStatusLists": hiddenFromStatusLists, "customLists": customLists, "advancedScores": advancedScores, "startedAt": startedAt, "completedAt": completedAt]
  }
  ...
  public struct Data: GraphQLSelectionSet {
    ...
    public static var selections: [GraphQLSelection] {
      return [
        GraphQLField("SaveMediaListEntry", arguments: ["id": GraphQLVariable("id"), "status": GraphQLVariable("status"), "score": GraphQLVariable("score"), "progress": GraphQLVariable("progress"), "progressVolumes": GraphQLVariable("progressVolumes"), "repeat": GraphQLVariable("repeat"), "priority": GraphQLVariable("priority"), "private": GraphQLVariable("private"), "notes": GraphQLVariable("notes"), "hiddenFromStatusLists": GraphQLVariable("hiddenFromStatusLists"), "customLists": GraphQLVariable("customLists"), "advancedScores": GraphQLVariable("advancedScores"), "startedAt": GraphQLVariable("startedAt"), "completedAt": GraphQLVariable("completedAt")], type: .object(SaveMediaListEntry.selections)),
      ]
    }
