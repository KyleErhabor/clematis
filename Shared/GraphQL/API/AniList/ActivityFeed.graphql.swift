...
public final class ActivityFeedQuery: GraphQLQuery {
  ...
  public let operationDefinition: String =
    """
    query ActivityFeed($page: Int!, $perPage: Int!, $isFollowing: Boolean!, $hasRepliesOrTypeText: Boolean!) {
  ...
  public init(page: Int, perPage: Int, isFollowing: Bool, hasRepliesOrTypeText: Bool) {
    self.page = page
  ...
  public var variables: GraphQLMap? {
    return ["page": page, "perPage": perPage, "isFollowing": isFollowing, "hasRepliesOrTypeText": hasRepliesOrTypeText]
  }
  ...
  public struct Data: GraphQLSelectionSet {
    ...
    public struct Page: GraphQLSelectionSet {
      ...
      public struct Activity: GraphQLSelectionSet {
        ...
        public static func makeListActivity(id: Int) -> Activity {
          return Activity(unsafeResultMap: ["__typename": "ListActivity", "id": id])
        }
        ...
        public struct AsListActivity: GraphQLSelectionSet {
          ...
          public init(id: Int) {
            self.init(unsafeResultMap: ["__typename": "ListActivity", "id": id])
          }
